...
// the only secures it from being visible in git hub. it's not end-all, be-all in security. Only protects keys from being readily accessible on github
      ...
      case "pizza":
        ...
        axios
          ...
          .then(response => {
            ...
            // the dock chain variable access represents of the following store folder. 
